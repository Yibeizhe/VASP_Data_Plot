...
path = os.listdir()
print(path)
ZFOCM=averChar('FeZn2O4_C_MoSe2_chg_aver.dat')
...
#Graphene
plt.axvline(x=0.55477600*40,color='black',linewidth=1,alpha=0.6)
#MoSe2
...
plt.fill_between(ang,averC,where=averC>0,color='#FDB4B6')
plt.fill_between(ang,averC,where=averC<0,color='#1D37A3',alpha=0.8)
