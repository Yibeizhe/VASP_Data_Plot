...
def MoSe2_MoO2_Graphene():
    ...
    MoO2_Mo.tot_plot(label='MoO$_{2}$-Mo',color='#007E01',ld=1.5)
    MoSe2_Mo = Dosplot('PDOS_MoSe2-Mo.dat')
    MoSe2_Mo.tot_plot(label='MoSe$_{2}$-Mo',color='red',ld=1.5)
    OSeC = Dosplot('PDOS_SUM.dat')
    OSeC.tot_plot(label='CSeO',color='lightseagreen',ld=1.5)
...
if __name__=="__main__":
    ...
    plt.xlim(-1.5,1)
    plt.ylim(0,40)
    plt.savefig('MoO2-MoSe-Graphene_PDOS', figsize=(4, 3), dpi=300, bbox_inches='tight')
    plt.show()
