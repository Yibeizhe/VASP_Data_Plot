...
class Dosplot():
    ...
    def p_plot(self,p='p',cp='#FDB4B6',ld=2):
    ...
    def d_plot(self,d='d',cd='#1D37A3',ld=2):
...
def mdn2p(metal):
    ...
    m_up = Dosplot('PDOS_Hf_UP.dat')
    m_up.d_plot(d='$Hf_{5d}$')
...
if __name__=="__main__":
    ...
    plt.xlim(-3,3)
    plt.ylim(0,1.2)
    plt.savefig('h-{}N_2'.format("Hf"), figsize=(6, 2), dpi=300, bbox_inches='tight')
    # plt.show()
